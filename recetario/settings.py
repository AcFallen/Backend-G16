...
SECRET_KEY = 'django-insecure-r#q!2mj))j)n!hwucv1vm&(=$yllc6_a9ao$*-hq*mg+sl*n0d'
...
REST_FRAMEWORK = {
    # sirve para indicar djangorestframwork que la autenticacion se realizara mediante la nueva libreria
